Feature: A new reading tip can be saved
  ...
  Scenario: Saving a reading tip of type blogpost is successful
    ...
    When title "testiblogi" and description "testikuvaus" and creator "testitekijä" and name "postauksen nimi" and url "www.blogger.com/blog" and date "2017-12-01" and tags "blog, tag" are entered
    Then system will respond with message "Seuraavat tiedot tallennettu:"
